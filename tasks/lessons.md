...
- For public config dataclasses, keep the main user-facing knobs required but infer secondary options from the packaged default config when possible, so quick-start examples stay short without drifting away from CLI defaults.
