...
def patching(
    ...
    file_path, tile_df = wsi_object.process_contours(
        ...
        save_patches_in_tarball=save_patches_in_tarball,
        ...
        for i in t:
            ...
            if patch:
                ...
                file_path, tile_df, patch_time_elapsed = patching(
                    ...
                    save_patches_in_tarball=patch_params.save_patches_in_tarball,
                    compress_individually=patch_params.compress_individually,
