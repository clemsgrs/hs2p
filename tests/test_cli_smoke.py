...
def test_sampling_main_smoke_uses_current_schema_and_manifest(
    ...
    def _fake_process_slide_wrapper(kwargs):
        ...
        meta_path.write_text(
            '{"provenance":{"sample_id":"slide-1","image_path":"slide-1.svs","mask_path":"slide-1-mask.png","backend":"asap","requested_backend":"asap"},"slide":{"dimensions":[256,256],"base_spacing_um":0.5,"level_downsamples":[1.0]},"tiling":{"requested_tile_size_px":256,"requested_spacing_um":0.5,"read_level":0,"effective_tile_size_px":256,"effective_spacing_um":0.5,"tile_size_lv0":256,"use_padding":true,"tolerance":0.05,"step_px_lv0":256,"overlap":0.0,"min_tissue_fraction":0.1,"is_within_tolerance":true,"n_tiles":1},"segmentation":{"tissue_method":"unknown","seg_downsample":64,"seg_level":0,"seg_spacing_um":0.5,"sthresh":8,"sthresh_up":255,"mthresh":7,"close":4,"use_otsu":false,"use_hsv":true,"mask_path":"slide-1-mask.png","ref_tile_size_px":16,"tissue_mask_tissue_value":null,"mask_level":null,"mask_spacing_um":null},"filtering":{"a_t":4,"a_h":2,"filter_white":false,"filter_black":false,"white_threshold":220,"black_threshold":25,"fraction_threshold":0.9},"artifact":{"coordinate_space":"level0_px","tile_order":"x_then_y","annotation":"tumor","selection_strategy":"independent_sampling","output_mode":"per_annotation"}}\n'
        )
