...
class WSI(object):
    ...
    def segment_tissue(
        ...
        """
        Segment tissue at the configured segmentation level.

        Args:
            segment_params: Segmentation parameters including method and thresholding details.
        ...
        img_thresh = segment_tissue_image(img, config=segment_params)
